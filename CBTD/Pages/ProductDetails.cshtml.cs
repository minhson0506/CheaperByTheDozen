...
namespace CBTD.Pages
{
    ...
    public class ProductDetailsModel : PageModel
    {
        ...
        public IActionResult OnPost(Product objProduct)
        {
            ...
            //does the user have a shopping cart with that product already
            ShoppingCart cartFromDb = _unitOfWork.ShoppingCart.Get(u => u.ApplicationUserId == claim.Value && u.ProductId == objProduct.Id);
