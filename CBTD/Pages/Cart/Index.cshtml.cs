...
namespace CBTD.Pages.Cart
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            ...
            //Console.WriteLine("currency" + ShoppingCartVM.CartTotal.ToString("c"));
            //Console.WriteLine("currency" + ShoppingCartVM.CartTotal.ToString("c", CultureInfo.CreateSpecificCulture("en-US")));
            //Console.WriteLine("currency" + ShoppingCartVM.CartTotal + (new RegionInfo(System.Threading.Thread.CurrentThread.CurrentUICulture.LCID)).ISOCurrencySymbol);
